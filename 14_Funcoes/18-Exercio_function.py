...
def listar_produtos(*listas):
    '''
    Funcao faz a listagem dos produtos
    Pega uma lista de produtos e retorna apenas o nome deles sem duplicatas (set)
    '''
...
print(listar_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_abr, estoque_fim_mar))
print(f'Qtd Produto: {len(listar_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_abr, estoque_fim_mar))}')
